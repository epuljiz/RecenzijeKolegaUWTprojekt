from . import auth_bp  # Dodaj na početku
...
def register():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash(
                'Registracija uspješna, ali nismo mogli poslati verifikacijski email.', 'warning')
    ...
    if form.validate_on_submit():
        ...
        if user_data and check_password_hash(user_data['password'], form.password.data):
            ...
            if not user_data.get('email_verified', False):
                flash('Molimo verificirajte svoj email prije prijave.', 'warning')
